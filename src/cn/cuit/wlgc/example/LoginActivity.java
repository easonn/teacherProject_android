...
import cn.cuit.wlgc.example.validations.PasswordValidation;
import cn.cuit.wlgc.example.validations.UserNameValidation;
...
public class LoginActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextValidator = new EditTextValidator(this)
                ...
                .add(new ValidationModel(usernameEditText,
                        new UserNameValidation()))
                .add(new ValidationModel(passwordEditText,
